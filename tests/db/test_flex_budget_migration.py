            ...
            connection.execute(
                sa.text(
                    ...
                    INSERT INTO budget_buckets (
                        ...
                        ('bucket-1', 'budget-flex', '2026-02', 'Fixed', 1200.00, 1200.00, 'Carry Positive'),
                        ('bucket-5', 'budget-flex', '2026-03', 'Fixed', 1000.00, 950.00, 'NOT_A_POLICY'),
                        ('bucket-2', 'budget-flex', '2026-02', 'non-monthly', 300.00, 0.00, 'carry both'),
                        ('bucket-3', 'budget-flex', '2026-02', 'flex', 600.00, 250.00, 'carry-negative'),
